...
# pinecone
from api.utils.services.pinecone_adapter import upsert_embeddings, query_by_vector
...
def _get_semantic_chunker():
    from api.utils.services.semantic_splitter import SemanticChunker
        ...
        if message.get("image"):
            try:
                ...
                if message.get("content"):
                    ...
                    message_parts.append("Name the bug bite in the image, no descriptions needed")
            ...
            if message.get("content"):
                ...
                results = query_by_vector(
                    ...
                    top_k=5,
                    metadata_filter=None,  # e.g. {"bug": {"$eq": "mosquito"}}..
                )
                #collection.query(
