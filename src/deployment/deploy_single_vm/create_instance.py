...
def create_instance():
    ...
    gcp_service_account_email = pulumi.Config("security").require("gcp_service_account_email")
    ...
    instance = gcp.compute.Instance(
        ...
        network_interfaces=[
            gcp.compute.InstanceNetworkInterfaceArgs(
                ...
                access_configs=[gcp.compute.InstanceNetworkInterfaceAccessConfigArgs(network_tier="STANDARD")],
            )
        ],
        ...
        opts=ResourceOptions(depends_on=[firewall_http, firewall_https, firewall_ssh, persistent_disk]),
    )
