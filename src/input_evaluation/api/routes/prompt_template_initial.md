...
2. Check if the message mentions location/context (camping, forest, park, hiking, bed, outdoors). It is acceptable if the user mentions that they do not remember or know the location.
...
- If message has some information about BOTH symptoms AND location: complete = true
- If message missing symptoms OR location: complete = false, improve_message = "For best results, tell us your symptoms and where you were when you got bit." It is acceptable if the user mentions that they do not remember or know the location.
